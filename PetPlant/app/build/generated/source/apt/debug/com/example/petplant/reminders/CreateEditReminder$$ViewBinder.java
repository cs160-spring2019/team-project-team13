...
public class CreateEditReminder$$ViewBinder<T extends CreateEditReminder> implements ViewBinder<T> {
  ...
  protected static class InnerUnbinder<T extends CreateEditReminder> implements Unbinder {
    ...
    protected InnerUnbinder(final T target, Finder finder, Object source) {
      ...
      View view;
      target.timeText = finder.findRequiredViewAsType(source, 2131230973, "field 'timeText'", TextView.class);
      target.dateText = finder.findRequiredViewAsType(source, 2131230794, "field 'dateText'", TextView.class);
      view = finder.findRequiredView(source, 2131230975, "method 'timePicker'");
      view2131230975 = view;
      ...
      view = finder.findRequiredView(source, 2131230795, "method 'datePicker'");
      view2131230795 = view;
      view.setOnClickListener(new DebouncingOnClickListener() {
        @Override
        public void doClick(View p0) {
