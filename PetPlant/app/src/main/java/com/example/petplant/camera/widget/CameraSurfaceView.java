package com.example.petplant.camera.widget;
...
import com.example.petplant.camera.util.LogUtil;
import com.example.petplant.camera.util.ScreenSizeUtil;
import com.example.petplant.camera.util.ToastUtil;
